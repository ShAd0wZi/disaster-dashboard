...
2.  **Install dependencies:** (Make sure you have Node.js installed, obviously).
...
4.  **Open it up:** Go to `http://localhost:5173` (or whatever port Vite tells you) and you're golden.
...
*Created by [ShAd0wZi](https://www.google.com/search?q=https://github.com/ShAd0wZi).*
